      ...
      <div className="   lg:mt-10 mt-40 flex flex-col justify-center items-center w-full lg:w-1/2 p-6 sm:p-8 space-y-6 lg:space-y-8 lg:h-full ">
        <LampContainer className="  flex flex-col items-center text-center space-y-4 sm:space-y-6 ">
          ...
          <motion.h1
            ...
            className=" dark:text-white text-cyan-100    bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-3xl sm:text-4xl md:text-5xl lg:text-4xl font-medium tracking-tight text-transparent "
          >
            "Curious Learner  and
